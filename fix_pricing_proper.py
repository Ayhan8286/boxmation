...
def fix_pricing():
    filepath = 'd:/boxmation/pricing.html'
    with codecs.open(filepath, 'r', 'utf-8') as f:
        html = f.read()

    # Remove the canvas from anywhere else
    html = re.sub(r'<canvas id="pricing-bg"[^>]*></canvas>\n?', '', html)
    ...
    if section:
        ...
        new_canvas = soup.new_tag('canvas', id='pricing-bg', style='opacity: 1;')
    ...
    print("Injected canvas inside pricing section!")
